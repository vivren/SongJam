...
class CreateForm(FlaskForm):
    ...
    roomType = RadioField(choices=['Public Room', 'Private Room'], default='Public Room', validators=[DataRequired()], render_kw={'style': 'margin: auto;'})
    roomPassword = StringField(validators=[DataRequired()], render_kw={'placeholder': 'Room Password', 'class': 'form-control', 'style': 'width: 75%; margin: auto; visibility: hidden;'})
